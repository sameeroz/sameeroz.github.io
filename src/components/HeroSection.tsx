      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        {/* <div className={`mb-8 transition-all duration-1000 delay-300 ${isVisible ? 'scale-100 opacity-100' : 'scale-50 opacity-0'}`}>
          <div className="relative w-32 h-32 mx-auto mb-6">
            <div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-500 to-blue-500 animate-pulse"></div>
            ...
            <div className="absolute -inset-4 rounded-full bg-gradient-to-r from-blue-500/20 to-blue-500/20 blur-lg"></div>
          </div>
